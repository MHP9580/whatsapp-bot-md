...
module.exports = {
  ...
  ANTILINK_MSG: process.env.ANTILINK_MSG || '_Lien détecté &mention supprimé_',
  ANTISPAM_MSG: process.env.ANTISPAM_MSG || '_Spam Detecté &mention supprimé_',
  ANTIWORDS_MSG: process.env.ANTIWORDS_MSG || '_Mot interdit détecté &mention banni_',
  ...
  ANTI_BOT_MESSAGE: process.env.ANTI_BOT_MESSAGE || '&mention supprimé_',
  WARN_MESSAGE:
    process.env.WARN_MESSAGE ||
    '⚠️AVERTISSEMENT⚠️\n*Utilisateur :* &mention\n*Avertissements restants:* &remaining /3',
  WARN_RESET_MESSAGE:
    process.env.WARN_RESET_MESSAGE || `Avertissements redemarrés\nUtilisateur : &mention\nAvertissements : &remaining /3`,
  WARN_KICK_MESSAGE: process.env.WARN_KICK_MESSAGE || '&mention banni',
